...
import { ConfirmSimulatedTransactionPanel } from './confirm-simulated-tx-panel'
...
const mockEvmTxInfos: BraveWallet.TransactionInfo[] = [
  deserializeTransaction({
    ...mockTransactionInfo,
    fromAddress: mockTransactionInfo.fromAddress,
  ...
  return (
    <WalletPanelStory
      ...
      walletApiDataOverrides={{
        ...
        selectedAccountId: findAccountByAddress(
          _mockEvmAccountInfos,
          mockEvmTxInfos[0].fromAddress
        )?.accountId,
  ...
  return (
    <WalletPanelStory
      ...
      walletApiDataOverrides={{
        ...
        selectedAccountId: findAccountByAddress(
          _mockSvmAccountInfos,
          mockSvmTxInfos[0].fromAddress
        )?.accountId,
