...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_NOTIFICATION_AD_CONSTANTS_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_NOTIFICATION_AD_CONSTANTS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_NOTIFICATION_AD_CONSTANTS_H_
