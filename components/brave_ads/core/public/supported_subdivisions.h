...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_SUPPORTED_SUBDIVISIONS_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_SUPPORTED_SUBDIVISIONS_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_SUPPORTED_SUBDIVISIONS_H_
