...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_ADS_SEARCH_RESULT_AD_FEATURE_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_ADS_SEARCH_RESULT_AD_FEATURE_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_ADS_SEARCH_RESULT_AD_FEATURE_H_
