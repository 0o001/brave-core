...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_CATEGORY_CONTENT_INFO_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_CATEGORY_CONTENT_INFO_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_PUBLIC_CATEGORY_CONTENT_INFO_H_
