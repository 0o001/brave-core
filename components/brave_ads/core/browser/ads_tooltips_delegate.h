...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_ADS_TOOLTIPS_DELEGATE_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_ADS_TOOLTIPS_DELEGATE_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_ADS_TOOLTIPS_DELEGATE_H_
