...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_ADS_SERVICE_CALLBACK_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_ADS_SERVICE_CALLBACK_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_ADS_SERVICE_CALLBACK_H_
