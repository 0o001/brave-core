...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_DEVICE_ID_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_DEVICE_ID_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_BROWSER_DEVICE_ID_H_
