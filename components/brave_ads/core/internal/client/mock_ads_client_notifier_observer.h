...
#ifndef BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_CLIENT_MOCK_ADS_CLIENT_NOTIFIER_OBSERVER_H_
#define BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_CLIENT_MOCK_ADS_CLIENT_NOTIFIER_OBSERVER_H_
...
#endif  // BRAVE_COMPONENTS_BRAVE_ADS_CORE_INTERNAL_CLIENT_MOCK_ADS_CLIENT_NOTIFIER_OBSERVER_H_
