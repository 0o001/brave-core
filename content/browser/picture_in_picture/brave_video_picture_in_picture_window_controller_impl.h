...
#ifndef BRAVE_CONTENT_BROWSER_PICTURE_IN_PICTURE_VIDEO_PICTURE_IN_PICTURE_WINDOW_CONTROLLER_IMPL_H_
#define BRAVE_CONTENT_BROWSER_PICTURE_IN_PICTURE_VIDEO_PICTURE_IN_PICTURE_WINDOW_CONTROLLER_IMPL_H_
...
class CONTENT_EXPORT BraveVideoPictureInPictureWindowControllerImpl:
  ...
  // non-null.
  static BraveVideoPictureInPictureWindowControllerImpl* GetOrCreateForWebContents(
 ...
 private:
  ...
  // Use BraveVideoPictureInPictureWindowControllerImpl::GetOrCreateForWebContents()
  // to create an instance.
  explicit BraveVideoPictureInPictureWindowControllerImpl(WebContents* web_contents);

};

}  // namespace content

#endif  // BRAVE_CONTENT_BROWSER_PICTURE_IN_PICTURE_VIDEO_PICTURE_IN_PICTURE_WINDOW_CONTROLLER_IMPL_H_
